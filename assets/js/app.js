(function () {
  var CART_KEY = "hightac-salam-cart-v1";
  var SUBMISSION_KEY = "hightac-salam-last-submission-v1";
  var LANG_KEY = "hightac-salam-language-v1";
  var DEFAULT_LANG = "fr";
  ...
  function getCatalog() {
    ...
    return {
      model: {
        name: "Salam",
        motorPicture: "Database/MotorPictures/Salam.png"
      },
      parts: []
    };
  }
  ...
  function submitCart() {
    ...
    var modelName = state.catalog.model.name || "Salam";
